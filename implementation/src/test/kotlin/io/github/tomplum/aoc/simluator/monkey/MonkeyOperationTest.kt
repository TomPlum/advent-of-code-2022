...
class MonkeyOperationTest {
    ...
    fun multiplyByInteger() {
        ...
        val newWorryLevel = operation.execute(BigInteger.valueOf(2))
    ...
    fun addToInteger() {
        ...
        val newWorryLevel = operation.execute(BigInteger.valueOf(26))
    ...
    fun multiplyByOld() {
        ...
        val newWorryLevel = operation.execute(BigInteger.valueOf(10))
    ...
    fun unknownOperator() {
        ...
        val e = assertThrows<IllegalArgumentException> {  operation.execute(BigInteger.valueOf(10)) }
